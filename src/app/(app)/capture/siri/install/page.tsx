  ...
  return (
    <div className="page-stack">
      <section className="dashboard-hero dashboard-hero-compact">
        <div>
          <p className="page-eyebrow">Siri / Shortcuts</p>
          <h1 className="page-title">Installa gli shortcuts di Quadra</h1>
          <p className="page-subtitle dashboard-subtitle-compact">
            Questa pagina serve per l’utente finale: deve solo toccare “Installa”. Il flusso corretto usa un link iCloud Apple oppure
              ...
              <article key={action.key} className="panel-card page-section-card">
                ...
                <div className="stack-sm">
                  ...
                  <div className="cluster-wrap">
                    {install?.installUrl ? (
                      <Link href={install.installUrl} target="_blank">Installa</Link>
                    ) : (

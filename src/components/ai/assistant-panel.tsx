  ...
  return (
    <section className="panel-card assistant-panel">
      ...
      <div className="assistant-links" style={{ marginTop: 12 }}>
        ...
        <a href="/capture/voice" className="ghost-button">Detta in Quadra</a>
        <a href="/capture/siri" className="ghost-button">Shortcut ufficiale</a>
      </div>
      ...
      <div className="helper-text" style={{ marginTop: 10 }}>
        Oggi: {data.kpis.todayCount ?? 0} follow-up · {data.kpis.overdueCount ?? 0} in ritardo · {data.kpis.openCount ?? 0} opportunità aperte.
      </div>
    </section>
  )
}

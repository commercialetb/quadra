    ...
    <section className="quadra-dashboard-card quadra-dashboard-ai-card">
      <div className="quadra-dashboard-card-head">
        <div>
          ...
          <p>Una domanda, una risposta utile. Tono più vicino al concept Quadra.</p>
        </div>
      ...
      {mobile ? (
        ...
        <div className="quadra-dashboard-ai-actions">
          <Link href="/assistant?prompt=brief%20priorita%20oggi" className="quadra-pill-button primary">Genera brief</Link>
          <Link href="/assistant" className="quadra-pill-button ghost">Interroga il CRM</Link>
        </div>
      )}
    </section>
  )

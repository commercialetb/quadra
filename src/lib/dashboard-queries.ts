...
export async function getDashboardData() {
  ...
  const [
    ...
    supabase
      .from('followups')
      .select('id, title, due_at, priority, status, company_id, contact_id, opportunity_id, project_id')
    ...
    supabase
      .from('activities')
      .select('id, kind, subject, content, happened_at, company_id, contact_id, opportunity_id, project_id')

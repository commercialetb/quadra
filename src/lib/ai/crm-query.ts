...
type CompanySnapshot = { id: string; name: string; city?: string | null; status?: string | null; notes_summary?: string | null; updated_at?: string | null };
type ContactSnapshot = { id: string; full_name: string; email?: string | null; role?: string | null; company_id?: string | null; updated_at?: string | null; companies?: { name?: string | null } | null };
type OpportunitySnapshot = { id: string; title: string; stage?: string | null; value_estimate?: number | null; probability?: number | null; next_action?: string | null; next_action_due_at?: string | null; expected_close_date?: string | null; company_id?: string | null; primary_contact_id?: string | null; updated_at?: string | null; companies?: { name?: string | null } | null; contacts?: { full_name?: string | null } | null };
type NoteSnapshot = { id: string; entity_type: string; entity_id: string; title?: string | null; body?: string | null; created_at: string };
type FollowupSnapshot = { id: string; title: string; due_at: string; status?: string | null; priority?: string | null; company_id?: string | null; contact_id?: string | null; opportunity_id?: string | null };
